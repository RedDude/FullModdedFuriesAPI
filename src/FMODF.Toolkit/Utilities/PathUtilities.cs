...
namespace FullModdedFuriesAPI.Toolkit.Utilities
{
    ...
    public static class PathUtilities
    {
        ...
        *********/
        ...
        /// <remarks>
        ///
        /// NOTE: this is a heuristic implementation that works in the cases FMODF needs it for, but it doesn't handle all edge cases (e.g. case-sensitivity on Linux, or traversing between UNC paths on Windows). This should be replaced with the more comprehensive <c>Path.GetRelativePath</c> if the game ever migrates to .NET Core.
        ///
        /// </remarks>
        [Pure]
