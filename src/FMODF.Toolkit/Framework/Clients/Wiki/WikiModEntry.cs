...
namespace FullModdedFuriesAPI.Toolkit.Framework.Clients.Wiki
{
    ...
    public class WikiModEntry
    {
        ...
        *********/
        ...
        /// <summary>Whether a Full Metal Furies or FMODF beta which affects mod compatibility is in progress. If this is true, <see cref="BetaCompatibility"/> should be used for beta versions of FMODF instead of <see cref="Compatibility"/>.</summary>
