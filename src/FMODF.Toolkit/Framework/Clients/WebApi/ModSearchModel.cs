...
namespace FullModdedFuriesAPI.Toolkit.Framework.Clients.WebApi
{
    ...
    public class ModSearchModel
    {
        ...
        *********/
        ...
        /// <summary>The FMODF version installed by the player. This is used for version mapping in some cases.</summary>
        public ISemanticVersion ApiVersion { get; set; }

        /// <summary>The Full Metal Furies version installed by the player.</summary>
        ...
        *********/
        ...
        /// <param name="apiVersion">The FMODF version installed by the player. If this is null, the API won't provide a recommended update.</param>
        /// <param name="gameVersion">The Full Metal Furies version installed by the player.</param>
