...
namespace FullModdedFuriesAPI.Toolkit.Framework.Clients.WebApi
{
    ...
    public class ModExtendedMetadataModel
    {
        ...
        ****/
        ...
        /// <summary>The latest unofficial version for the current Full Metal Furies or FMODF beta, if any.</summary>
        ...
        ****/
        ...
        /// <summary>The game or FMODF version which broke this mod, if applicable.</summary>
        public string BrokeIn { get; set; }

        /****
        ** Beta compatibility
        ****/
        /// <summary>The compatibility status for the Full Metal Furies beta (if any).</summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public WikiCompatibilityStatus? BetaCompatibilityStatus { get; set; }

        /// <summary>The human-readable summary of the compatibility status or workaround for the Full Metal Furies beta (if any), without HTML formatting.</summary>
        public string BetaCompatibilitySummary { get; set; }

        /// <summary>The beta game or FMODF version which broke this mod, if applicable.</summary>
        ...
        *********/
        ...
        /// <param name="db">The mod metadata from FMODF's internal DB (if available).</param>
        ...
        /// <param name="unofficialForBeta">The latest unofficial version for the current Full Metal Furies or FMODF beta, if any.</param>
