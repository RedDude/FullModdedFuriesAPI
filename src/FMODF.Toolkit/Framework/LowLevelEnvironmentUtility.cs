...
namespace FullModdedFuriesAPI.Toolkit.Framework
{
    /// <summary>Provides low-level methods for fetching environment information.</summary>
    /// <remarks>This is used by the FMODF core before the toolkit DLL is available; most code should use <see cref="EnvironmentUtility"/> instead.</remarks>
