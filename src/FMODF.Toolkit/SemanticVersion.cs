...
namespace FullModdedFuriesAPI.Toolkit
{
    ...
    ///
    /// This optionally also supports four-part versions, a non-standard extension used by Full Metal Furies on ported platforms to represent platform-specific patches to a ported version, represented as a fourth number in the version string.
    /// </remarks>
    public class SemanticVersion : ISemanticVersion
    {
        ...
        *********/
        ...
        /// <summary>The platform release. This is a non-standard semver extension used by Full Metal Furies on ported platforms to represent platform-specific patches to a ported version, represented as a fourth number in the version string.</summary>
