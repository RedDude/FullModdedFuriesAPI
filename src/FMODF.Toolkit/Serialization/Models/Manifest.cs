...
using FullModdedFuriesAPI.Toolkit.Serialization.Converters;

namespace FullModdedFuriesAPI.Toolkit.Serialization.Models
{
    /// <summary>A manifest which describes a mod for FMODF.</summary>
    public class Manifest : IManifest
    {
        ...
        *********/
        ...
        /// <summary>The minimum FMODF version required by this mod, if any.</summary>
