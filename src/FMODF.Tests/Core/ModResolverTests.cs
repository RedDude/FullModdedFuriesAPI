...
using SemanticVersion =FullModdedFuriesAPI.SemanticVersion;

namespace FMODF.Tests.Core
{
    ...
    public class ModResolverTests
    {
        ...
        ****/
        ...
        [Test(Description = "Assert that validation fails when the minimum API version is higher than the current FMODF version.")]
        ...
        *********/
        ...
        {
            return Path.Combine(Path.GetTempPath(), "fmodf-unit-tests", Guid.NewGuid().ToString("N"));
        }
        ...
        /// <param name="modRecord">The extra metadata about the mod from FMODF's internal data (if any).</param>
