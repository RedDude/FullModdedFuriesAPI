...
namespace FMODF.Tests.Utilities
{
    ...
    internal class PathUtilitiesTests
    {
        ...
        ****/
        ...
        [TestCase(
            @"~/parent",
            @"~/PARENT/child",
            ExpectedResult = @"child" // note: incorrect on Linux and sometimes macOS, but not worth the complexity of detecting whether the filesystem is case-sensitive for FMODF's purposes
        )]
#endif
