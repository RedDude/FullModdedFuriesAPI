...
// using FullModdedFuriesAPI.Mods.ConsoleCommands.Framework.ItemData;
// using Brawler2D;
// using Brawler2D.GameData.FishPond;
// using Brawler2D.Menus;
// using Brawler2D.Objects;
// using Brawler2D.Tools;
// using SObject = Brawler2D.Object;
//
// namespace FullModdedFuriesAPI.Mods.ConsoleCommands.Framework
// {
...
//         /// <remarks>Derived from <see cref="Brawler2D.Buildings.FishPond.GetFishProduce"/>.</remarks>
