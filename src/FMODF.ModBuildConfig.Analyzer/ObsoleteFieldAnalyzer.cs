...
namespace FullModdedFuriesAPI.ModBuildConfig.Analyzer
{
    ...
    public class ObsoleteFieldAnalyzer : DiagnosticAnalyzer
    {
        ...
        *********/
        ...
        {
            // Farmer
            ["Brawler2D.Farmer::friendships"] = "friendshipData"
        };
        ...
        private readonly IDictionary<string, DiagnosticDescriptor> Rules = new Dictionary<string, DiagnosticDescriptor>
        {
            ["AvoidObsoleteField"] = new DiagnosticDescriptor(
                ...
                messageFormat: "The '{0}' field is obsolete and should be replaced with '{1}'. See https://fmodf.io/package/avoid-obsolete-field for details.",
                category: "FMODF.CommonErrors",
                defaultSeverity: DiagnosticSeverity.Warning,
                isEnabledByDefault: true,
                helpLinkUri: "https://fmodf.io/package/avoid-obsolete-field"
            )
        };
