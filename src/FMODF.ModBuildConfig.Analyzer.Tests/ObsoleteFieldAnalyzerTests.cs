...
namespace FMODF.ModBuildConfig.Analyzer.Tests
{
    ...
    public class ObsoleteFieldAnalyzerTests : DiagnosticVerifier
    {
        ...
        *********/
        ...
        [TestCase("var x = new Farmer().friendships;", 8, "Brawler2D.Farmer.friendships", "friendshipData")]
        [TestCase("var x = new Farmer()?.friendships;", 8, "Brawler2D.Farmer.friendships", "friendshipData")]
        public void AvoidObsoleteField_RaisesDiagnostic(string codeText, int column, string oldName, string newName)
        {
            ...
            DiagnosticResult expected = new DiagnosticResult
            {
                ...
                Message = $"The '{oldName}' field is obsolete and should be replaced with '{newName}'. See https://fmodf.io/package/avoid-obsolete-field for details.",
