...
using FullModdedFuriesAPI.Web.Framework.Clients.Pastebin;
using FullModdedFuriesAPI.Web.Framework.Compression;
using FullModdedFuriesAPI.Web.Framework.ConfigModels;
using FullModdedFuriesAPI.Web.Framework.RedirectRules;
using FullModdedFuriesAPI.Web.Framework.Storage;

namespace FullModdedFuriesAPI.Web
{
        ...
        *********/
        ...
        private RewriteOptions GetRedirectRules()
        {
            var redirects = new RewriteOptions()
                ...
                {
                    [@"^/3\.0\.?$"] = "https://stardewvalleywiki.com/Modding:Migrate_to_FMODF_3.0",
                    [@"^/(?:buildmsg|package)(?:/?(.*))$"] = "https://github.com/Pathoschild/FMODF/blob/develop/docs/technical/mod-package.md#$1", // buildmsg deprecated, remove when SDV 1.4 is released
                    [@"^/community\.?$"] = "https://stardewvalleywiki.com/Modding:Community",
                    [@"^/compat\.?$"] = "https://fmodf.io/mods",
                    [@"^/docs\.?$"] = "https://stardewvalleywiki.com/Modding:Index",
                    [@"^/help\.?$"] = "https://stardewvalleywiki.com/Modding:Help",
                    [@"^/install\.?$"] = "https://stardewvalleywiki.com/Modding:Player_Guide/Getting_Started#Install_FMODF",
        ...
        private IDictionary<string, string> GetLegacyPathRedirects()
        {
            ...
            {
                ["Modding:Index#Migration_guides"] = new[] { "^/for-devs/updating-a-fmodf-mod", "^/guides/updating-a-fmodf-mod" },
                ["Modding:Modder_Guide"] = new[] { "^/for-devs/creating-a-fmodf-mod", "^/guides/creating-a-fmodf-mod", "^/for-devs/creating-a-fmodf-mod-advanced-config" },
                ["Modding:Player_Guide"] = new[] { "^/for-players/install-fmodf", "^/guides/using-mods", "^/for-players/faqs", "^/for-players/intro", "^/for-players/use-mods", "^/guides/asking-for-help", "^/guides/fmodf-faq" },
                ...
                ["Modding:IDE_reference"] = new[] { "^/for-devs/creating-a-fmodf-mod-ide-primer" },
