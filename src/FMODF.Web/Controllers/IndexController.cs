...
{
    /// <summary>Provides an info/download page about FMODF.</summary>
    [Route("")]
    internal class IndexController : Controller
    {
        ...
        *********/
        ...
        private readonly string RepositoryName = "Pathoschild/FMODF";
        ...
        *********/
        ...
        public async Task<ViewResult> Index()
        {
            ...
            IndexVersionModel stableVersionModel = stableVersion != null
                ...
                : new IndexVersionModel("unknown", "", "https://github.com/Pathoschild/FMODF/releases", null); // just in case something goes wrong)
        ...
        ** Private methods
        *********/
        /// <summary>Get a sorted, parsed list of FMODF downloads for the latest releases.</summary>
        ...
        /// <summary>Get a parsed list of FMODF downloads for a release.</summary>
        ...
        private IEnumerable<ReleaseVersion> ParseReleaseVersions(GitRelease release)
        {
            ...
            foreach (GitAsset asset in release.Assets)
            {
                ...
                Match match = Regex.Match(asset.FileName, @"FMODF-(?<version>[\d\.]+(?:-.+)?)-installer(?<forDevs>-for-developers)?.zip");
        ...
        private class ReleaseVersion
        {
            ...
            *********/
            ...
            /// <summary>The FMODF version.</summary>
            ...
            *********/
            ...
            /// <param name="version">The FMODF version.</param>
