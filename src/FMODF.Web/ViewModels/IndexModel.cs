namespace FullModdedFuriesAPI.Web.ViewModels
{
    ...
    public class IndexModel
    {
        ...
        ** Accessors
        *********/
        /// <summary>The latest stable FMODF version.</summary>
        public IndexVersionModel StableVersion { get; set; }

        /// <summary>The latest prerelease FMODF version (if newer than <see cref="StableVersion"/>).</summary>
        ...
        *********/
        ...
        /// <summary>Construct an instance.</summary>
        /// <param name="stableVersion">The latest stable FMODF version.</param>
        /// <param name="betaVersion">The latest prerelease FMODF version (if newer than <paramref name="stableVersion"/>).</param>
