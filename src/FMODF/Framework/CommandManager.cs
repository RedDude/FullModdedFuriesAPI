...
namespace FullModdedFuriesAPI.Framework
{
    ...
    internal class CommandManager
    {
        ...
        ** Fields
        *********/
        /// <summary>The commands registered with FMODF.</summary>
        ...
        *********/
        ...
        /// <param name="mod">The mod adding the command (or <c>null</c> for a FMODF command).</param>
        ...
        /// <summary>Add a console command.</summary>
        /// <param name="command">the FMODF console command to add.</param>
        /// <param name="monitor">Writes messages to the console.</param>
        /// <exception cref="ArgumentException">There's already a command with that name.</exception>
