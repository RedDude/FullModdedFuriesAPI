...
// #endif
//
// namespace FullModdedFuriesAPI.Framework.Patching
// {
...
//         {
// #if HARMONY_2
//             Harmony harmony = new Harmony("FMODF");
// #else
//             HarmonyInstance harmony = HarmonyInstance.Create("FMODF");
// #endif
...
//                 catch (Exception ex)
//                 {
//                     this.Monitor.Log($"Couldn't apply runtime patch '{patch.GetType().Name}' to the game. Some FMODF features may not work correctly. See log file for details.", LogLevel.Error);
