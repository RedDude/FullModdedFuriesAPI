...
namespace FullModdedFuriesAPI.Framework.ModLoading.RewriteFacades
{
    /// <summary>Provides <see cref="SpriteBatch"/> method signatures that can be injected into mod code for compatibility with mods written for XNA Framework before Full Metal Furies 1.5.5.</summary>
    /// <remarks>This is public to support FMODF rewriting and should not be referenced directly by mods.</remarks>
