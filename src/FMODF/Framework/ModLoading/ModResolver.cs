...
namespace FullModdedFuriesAPI.Framework.ModLoading
{
    ...
    internal class ModResolver
    {
        ...
        *********/
        ...
        /// <param name="apiVersion">The current FMODF version.</param>
        ...
        public void ValidateManifests(IEnumerable<IModMetadata> mods, ISemanticVersion apiVersion, Func<string, string> getUpdateUrl)
        {
            ...
            foreach (IModMetadata mod in mods)
            {
                    ...
                    case ModStatus.AssumeBroken:
                        {
                            ...
                            // default update URL
                            updateUrls.Add("https://fmodf.io/mods");
                ...
                // validate FMODF version
                if (mod.Manifest.MinimumApiVersion?.IsNewerThan(apiVersion) == true)
                {
                    mod.SetStatus(ModMetadataStatus.Failed, ModFailReason.Incompatible, $"it needs FMODF {mod.Manifest.MinimumApiVersion} or later. Please update FMODF to the latest version to use this mod.");
                    continue;
                }
        ...
        *********/
        ...
        private string GetTechnicalReasonForStatusOverride(IModMetadata mod)
        {
            ...
            // build message
            return
                $"marked {statusLabel} in FMODF's internal compatibility list for "
