...
namespace FullModdedFuriesAPI.Framework.ModLoading
{
    ...
    internal class PlatformAssemblyMap : IDisposable
    {
        ...
        ****/
        ...
        /// <summary>The short assembly names to remove as assembly reference, and replace with the <see cref="Targets"/>. These should be short names (like "Full Metal Furies").</summary>
        ...
        *********/
        ...
        /// <param name="removeAssemblyNames">The assembly short names to remove (like <c>Full Metal Furies</c>).</param>
