...
using FullModdedFuriesAPI.Framework.ModLoading.Framework;

namespace FullModdedFuriesAPI.Framework.ModLoading.Rewriters
{
        ...
        *********/
        ...
        public override bool Handle(ModuleDefinition module, ILProcessor cil, Instruction instruction)
        {
            ...
            if (loadInstructions.Any(p => p == null))
                return false; // FMODF needs to load the value onto the stack before the method call, but the optional parameter type wasn't recognized
