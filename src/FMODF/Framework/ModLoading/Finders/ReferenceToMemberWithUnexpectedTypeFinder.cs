...
namespace FullModdedFuriesAPI.Framework.ModLoading.Finders
{
    ...
    internal class ReferenceToMemberWithUnexpectedTypeFinder : BaseInstructionHandler
    {
        ...
        *********/
        ...
        private string GetFriendlyTypeName(TypeReference type)
        {
            ...
            foreach (string @namespace in new[] { "Microsoft.Xna.Framework", "BlitNet", "System", "System.Collections.Generic" })
            {
