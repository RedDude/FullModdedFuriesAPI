...
namespace FullModdedFuriesAPI.Framework.ContentManagers
{
    ...
    internal abstract class BaseContentManager : LocalizedContentManager, IContentManager
    {
        ...
        *********/
        ...
        public abstract IEnumerable<object> LoadSpritesheet(string assetName, bool useCache);
        ...
        ****/
        ...
        {
            if (this.IsDisposed)
                return; // base logic doesn't allow unloading twice, which happens due to FMODF and the game both unloading
