...
namespace FullModdedFuriesAPI.Framework.Content
{
        ...
        *********/
        ...
        public bool CanIntercept(IAssetInfo asset)
        {
            ...
            if (canIntercept == null)
                throw new InvalidOperationException($"FMODF couldn't access the {nameof(AssetInterceptorChange)}.{nameof(this.CanInterceptImpl)} implementation.");
