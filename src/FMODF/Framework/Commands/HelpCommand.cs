...
{
    /// <summary>The 'help' FMODF console command.</summary>
        ...
        *********/
        ...
        public void HandleCommand(string[] args, IMonitor monitor)
        {
            ...
            else
            {
                string message =
                    "\n\n"
                    + "Need help with a FMODF or mod issue?\n"
                    + "------------------------------------\n"
                    + "See https://fmodf.io/help for the best places to ask.\n\n\n"
                    + "How commands work\n"
                    + "-----------------\n"
                ...
                {
                    string modName = group.Key ?? "FMODF";
