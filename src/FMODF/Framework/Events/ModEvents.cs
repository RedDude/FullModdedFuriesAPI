...
{
    /// <summary>Manages access to events raised by FMODF.</summary>
    internal class ModEvents : IModEvents
    {
        ...
        *********/
        ...
        /// <summary>Events linked to persistence. Save, configuration and profile events.</summary>
        public IPersistenceEvents Persistence { get; }
        ...
        public IScreenEvents Screen { get; }
        ...
        *********/
        ...
        {
            this.Persistence = new ModPersistenceEvents(mod, eventManager);
            // this.Display = new ModDisplayEvents(mod, eventManager);
            this.GameLoop = new ModGameLoopEvents(mod, eventManager);
            this.Screen = new ModScreenEvents(mod, eventManager);
