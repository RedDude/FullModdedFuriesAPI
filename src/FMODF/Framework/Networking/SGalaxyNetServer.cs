...
// {
//     /// <summary>A multiplayer server used to connect to an incoming player. This is an implementation of <see cref="LidgrenServer"/> that adds support for FMODF's metadata context exchange.</summary>
...
//         /// <param name="multiplayer">FMODF's implementation of the game's core multiplayer logic.</param>
...
//                 else if (message.MessageType == Brawler2D.Multiplayer.playerIntroduction)
//                 {
