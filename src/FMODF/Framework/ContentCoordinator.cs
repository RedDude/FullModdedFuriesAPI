...
using FullModdedFuriesAPI.Framework.ContentManagers;
using FullModdedFuriesAPI.Framework.Reflection;
using FullModdedFuriesAPI.Metadata;
...
namespace FullModdedFuriesAPI.Framework
{
    ...
    internal class ContentCoordinator : IDisposable
    {
        ...
        ** Fields
        *********/
        /// <summary>An asset key prefix for assets from FMODF mod folders.</summary>
        private readonly string ManagedPrefix = "FMODF";
        ...
        *********/
        ...
        /// <summary>Get a new content manager which handles reading files from a FMODF mod folder with support for unpacked files.</summary>
        /// <param name="name">A name for the mod manager. Not guaranteed to be unique.</param>
        ...
        public void OnReturningToTitleScreen()
        {
            ...
            // causes an inconsistency in the FMODF asset cache, which leads to an edge case where assets already
            ...
            //   2. FMODF sees that it's already cached, and calls LoadRaw to bypass asset interception.
        ...
        /// <summary>Parse a managed FMODF asset key which maps to a mod folder.</summary>
        /// <param name="key">The asset key.</param>
        ...
        /// <param name="contentManagerID">The unique name for the content manager which should load this asset.</param>
        /// <param name="relativePath">The internal FMODF asset key.</param>
