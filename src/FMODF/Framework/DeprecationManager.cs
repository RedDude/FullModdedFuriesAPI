...
namespace FullModdedFuriesAPI.Framework
{
    ...
    internal class DeprecationManager
    {
        ...
        *********/
        ...
        /// <param name="version">The FMODF version which deprecated it.</param>
        ...
        public void PrintQueued()
        {
            ...
            {
                // build message
                string message = $"{warning.ModName} uses deprecated code ({warning.NounPhrase} is deprecated since FMODF {warning.Version}).";
