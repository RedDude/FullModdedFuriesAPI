...
using FullModdedFuriesAPI.Framework.StateTracking;
    ...
    internal class WatcherCore
    {
        ...
        *********/
        ...
        public WatcherCore(SInputState inputState)//, ObservableCollection<GameLocation> gameLocations)
        {
            ...
            // this.WindowSizeWatcher = WatcherFactory.ForEquatable(() => new Point(GameManager.viewport.Width, Game1.viewport.Height));
        ...
        public void Update()
        {
            ...
            {
                if (this.CurrentPlayerTracker == null || this.CurrentPlayerTracker.Player != GameController.g_game.PlayerManager.getMainPlayerOrHost)
                {
                    this.CurrentPlayerTracker?.Dispose();
                    this.CurrentPlayerTracker = new PlayerTracker(GameController.g_game.PlayerManager.getMainPlayerOrHost);
                }
            }
            else
            {
