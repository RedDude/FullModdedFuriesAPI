...
namespace FullModdedFuriesAPI.Framework.ModHelpers
{
    ...
    internal class ModHelper : BaseHelper, IModHelper, IDisposable
    {
        ...
        *********/
        ...
        /// <inheritdoc />
        public ILocateBuilderHelper LocateBuilder { get; }

        /// <inheritdoc />
        public IDatabaseHelper Database { get; }
        ...
        *********/
        ...
        /// <param name="events">Manages access to events raised by FMODF.</param>
        ...
        /// <param name="locateBuilderHelper">An API for reading Locate and Keys from the game.</param>
        /// <param name="databaseHelper">An API for reading and add new Entites to the game</param>
        /// <exception cref="ArgumentNullException">An argument is null or empty.</exception>
        /// <exception cref="InvalidOperationException">The <paramref name="modDirectory"/> path does not exist on disk.</exception>
        public ModHelper(string modID, string modDirectory,
            Func<SInputState> currentInputState,
            IModEvents events,
            IContentHelper contentHelper,
            IContentPackHelper contentPackHelper,
            ...
            ILocateBuilderHelper locateBuilderHelper,
            ...
            : base(modID)
        {
            ...
            this.LocateBuilder = locateBuilderHelper ?? throw new ArgumentNullException(nameof(locateBuilderHelper));
            this.Database = databaseHelper ?? throw new ArgumentNullException(nameof(databaseHelper));
            this.Events = events;
        }
