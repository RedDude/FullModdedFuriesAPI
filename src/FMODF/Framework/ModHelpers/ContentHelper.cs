...
namespace FullModdedFuriesAPI.Framework.ModHelpers
{
    ...
    internal class ContentHelper : BaseHelper, IContentHelper
    {
        ...
        ** Fields
        *********/
        /// <summary>FMODF's core content logic.</summary>
        ...
        *********/
        ...
        /// <param name="contentCore">FMODF's core content logic.</param>
        ...
        public IEnumerable<object> LoadSpritesheet(string key, ContentSource source = ContentSource.ModFolder)
        {
            try
            {
                this.AssertAndNormalizeAssetName(key);
                ...
                {
                    case ContentSource.GameContent:
                        return this.GameContentManager.LoadSpritesheet(key, useCache: false);

                    case ContentSource.ModFolder:
                        return this.ModContentManager.LoadSpritesheet(key, useCache: false);
        ...
        public bool IsSpritesheetLoaded(string assetName, ContentSource source)
        {
            return SpriteLibrary.IsSpritesheetLoaded(assetName);
        }
