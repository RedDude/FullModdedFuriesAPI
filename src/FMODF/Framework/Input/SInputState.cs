...
// namespace FullModdedFuriesAPI.Framework.Input
// {
...
internal sealed class SInputState : InputManager
{
    public SInputState(byte numInputs, GameServiceContainer service, GameWindow window) : base(numInputs, service, window)
    {
        // super(numInputs, service, window);
    }
...
//         ** Public methods
//         *********/
//         /// <summary>This method is called by the game, and does nothing since FMODF will already have updated by that point.</summary>
...
//             base.Update();
//
//             // update FMODF extended data
//             // note: Full Metal Furies is *not* in UI mode when this code runs
//             try
//             {
