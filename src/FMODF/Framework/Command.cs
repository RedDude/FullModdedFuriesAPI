...
{
    /// <summary>A command that can be submitted through the FMODF console to interact with FMODF.</summary>
    internal class Command
    {
        /*********
        ** Accessor
        *********/
        /// <summary>The mod that registered the command (or <c>null</c> if registered by FMODF).</summary>
        ...
        *********/
        ...
        /// <param name="mod">The mod that registered the command (or <c>null</c> if registered by FMODF).</param>
