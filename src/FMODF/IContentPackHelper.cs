...
namespace FullModdedFuriesAPI
{
    ...
    public interface IContentPackHelper : IModLinked
    {
        ...
        *********/
        ...
        /// <summary>Create a temporary content pack to read files from a directory, using randomized manifest fields. Temporary content packs will not appear in the FMODF log and update checks will not be performed.</summary>
        ...
        /// <summary>Create a temporary content pack to read files from a directory. Temporary content packs will not appear in the FMODF log and update checks will not be performed.</summary>
        /// <param name="directoryPath">The absolute directory path containing the content pack files.</param>
