...
namespace FullModdedFuriesAPI
{
    ...
    public static class Context
    {
        ...
        *********/
        ...
        private static bool IsWorldReadyForScreen = new();
        ...
        internal static bool IsSaveLoaded;//Game1.hasLoadedGame && !(Game.activeClickableMenu is TitleMenu);

        /// <summary>Whether the game is currently writing to the save file.</summary>
        // internal static bool IsSaving => GameController.g_game.ScreenManager.m_playAutosave;//Game1.activeClickableMenu is SaveGameMenu || Game1.activeClickableMenu is ShippingMenu; // saving is performed by SaveGameMenu, but it's wrapped by ShippingMenu on days when the player shipping something
        ...
        {
           get => LoadStage.None; //Context.LoadStageForScreen.Value;
            set
            {
            }
            //Context.LoadStageForScreen.Value = value;        }
        }
        ...
        ****/
        ...
        {
            get => Context.IsWorldReadyForScreen;
            set => Context.IsWorldReadyForScreen = value;
        }
