namespace FullModdedFuriesAPI.Enums
{
    ...
    public enum LoadStage
    {
        ...
        /// <summary>The game is loading a save slot, and has read the raw save data into <see cref="Brawler2D.SaveGame.loaded"/>. Not applicable when connecting to a multiplayer host. This is equivalent to <see cref="Brawler2D.SaveGame.getLoadEnumerator"/> value 20.</summary>
        SaveParsed = 4,

        /// <summary>The game is loading a save slot, and has applied the basic save info (including player data). Not applicable when connecting to a multiplayer host. Note that some basic info (like daily luck) is not initialized at this point. This is equivalent to <see cref="Brawler2D.SaveGame.getLoadEnumerator"/> value 36.</summary>
        ...
        /// <summary>The game is loading a save slot, and has restored the in-game location data. Not applicable when connecting to a multiplayer host. This is equivalent to <see cref="Brawler2D.SaveGame.getLoadEnumerator"/> value 50.</summary>
