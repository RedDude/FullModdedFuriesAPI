...
using FullModdedFuriesAPI.Framework.ModLoading.Finders;
using FullModdedFuriesAPI.Framework.ModLoading.RewriteFacades;
using FullModdedFuriesAPI.Framework.ModLoading.Rewriters;
using Brawler2D;

namespace FullModdedFuriesAPI.Metadata
{
    ...
    internal class InstructionMetadata
    {
        ...
        *********/
        ...
        private readonly ISet<string> ValidateReferencesToAssemblies = new HashSet<string> { "FullModdedFuriesAPI", "Full Metal Furies", "Brawler2D", "Netcode" };
        ...
        *********/
        ...
        public IEnumerable<IInstructionHandler> GetHandlers(bool paranoidMode, bool platformChanged, bool rewriteMods)
        {
            ...
            ****/
            ...
            if (rewriteMods)
            {
                // rewrite for Full Metal Furies 1.5
                ...
                // rewrite for Full Metal Furies 1.5.5
                if (platformChanged)
                ...
                // detect Harmony & rewrite for FMODF 3.12 (Harmony 1.x => 2.0 update)
