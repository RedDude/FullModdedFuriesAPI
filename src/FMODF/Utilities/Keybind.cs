...
namespace FullModdedFuriesAPI.Utilities
{
    ...
    public class Keybind
    {
        ...
        *********/
        ...
        // internal Func<SButton, SButtonState> GetButtonState { get; set; } = SGame.GetInputState; //me
        ...
        *********/
        ...
        {
            // SButtonState[] states = this.Buttons.Select(this.GetButtonState).Distinct().ToArray(); //me
            SButtonState[] states = null;
            // single state
            if (states.Length == 1)
                return states[0];
