...
namespace FullModdedFuriesAPI.Utilities
{
    ...
    public class KeybindList
    {
        ...
        *********/
        ...
        /// <remarks>See <see cref="Parse"/> or <see cref="TryParse"/> to parse it from a string representation. You can also use this type directly in your config or JSON data models, and it'll be parsed by FMODF.</remarks>
