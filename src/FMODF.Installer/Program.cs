...
using FullModdedFuriesAPI.Installer;

namespace FullModdedFuriesAPI.Installer
{
    /// <summary>The entry point for FMODF's install and uninstall console app.</summary>
    internal class Program
    {
        ...
        *********/
        ...
        private static readonly string ExtractedBundlePath = Path.Combine(Path.GetTempPath(), $"FMODF-installer-{Guid.NewGuid():N}");

        /// <summary>The absolute path for referenced assemblies.</summary>
        private static readonly string InternalFilesPath = Path.Combine(Program.ExtractedBundlePath, "fmodf-internal");
